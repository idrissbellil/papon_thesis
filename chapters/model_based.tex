...
\missingfigure{Figure showing point model and selected points}
...
\missingfigure{Add figure of virtual reality platform}
...
\missingfigure{Screenshots from this scenario}
...
\missingfigure{Plot showing track error vs degree of sampling. Also show number of particles on y axis. Fixed run-time. }
\missingfigure{Plot showing track error vs degree of sampling. Also show number of particles on y axis. Fixed run-time. }
...
\todo[inline]{Add results from these experiments}
